...
exports.postAddProduct = (req, res, next) => {
  ...
  req.user
    .createProduct({
      // createProduct because our Model is product (this method is develop when association happening with user and Product so sequelize created it automatically)
      title: title,
      imageUrl: imageUrl,
      price: price,
